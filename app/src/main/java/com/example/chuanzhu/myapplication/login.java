...
public class Login extends Activity implements OnClickListener{
    ...
    private static final String LOGIN_URL = "http://mikekorostelev.com/~bits/webservice/login.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bLogin = (Button)findViewById(R.id.login); bLogin.setOnClickListener(this);
    }
